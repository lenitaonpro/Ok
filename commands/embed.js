...
module.exports = {
    ...
    async execute(client, message,  args){
        if(message.author.id !== '614493910500376597') return message.channel.send('Kuka vittu sää oot?'); // if the member does not have permissions to mannage messages, return/stop reading the code.
